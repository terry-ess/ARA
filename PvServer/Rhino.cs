...
namespace Pv
{
    ...
    public class Rhino : IDisposable
    {
...
#endif
            DEFAULT_MODEL_PATH = RUtils.PvModelPath();	//12/13/2021 using RUtils rather then Utils because of interference with Porcupine
        }
        ...
        private static IntPtr ImportResolver(string libraryName, Assembly assembly, DllImportSearchPath? searchPath)
        {
            ...
            NativeLibrary.TryLoad(RUtils.PvLibraryPath(libraryName), out libHandle);	//12/13/2021 using RUtils rather then Utils because of interference with Porcupine
			return libHandle;
        }
#endif
		...
		// added 12/13/2021 for use in ARA, PvServer, PvSpeech.cs
		public RhinoStatus Reset()

		{
			return (pv_rhino_reset(_libraryPointer));
		}
